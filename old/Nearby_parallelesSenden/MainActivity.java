    ...
    private final PayloadCallback mPayloadCallback =
            new PayloadCallback() {
                ...
                public void onPayloadReceived(String endpointId, Payload payload) {
                    ...
                    Log.d(TAG, "Received number " +receivedPayload.charAt(receivedPayload.length() - 1));
        ...
        btnSend.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                if(mIsConnected) {
                    ...
                    for(int i = 0; i < 100; i++){
                        String str = "nur ein teststring, wird 100 Mal versendet und ist der: "+ i;
                        sendData(Payload.fromBytes(str.getBytes()));
                    }
